...
## 🚀 Instant Demo (Recruiter Mode)
The application features a **One-Click Instant Demo** mode. No registration is required—recruiters and evaluators can jump straight into the dashboard with pre-seeded data to experience the full feature set immediately.
